...
/* Arguments in order :
        ...
        - d : The private exponent in hexadecimal or emtpy
        - message : The message to encrypt/decrypt/verify/sign in hexadecimal
        - signature : The signature to verify in hexadecimal or empty
        - hash name : The name of the hash function to use to sign/verify the message or empty
        - padding : The name of the padding scheme to use to sign/verify the message or empty
        - E/D/S/V : "E" for encryption, "D" for decryption, "S" for sign, "V" for verify
*/
